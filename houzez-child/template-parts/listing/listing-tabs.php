...
if ( is_page( 18610 ) ) {
    // Adjust the label based on the total listings found
    if( $total_listing_found > 1 ) {
        $property_label = 'Assets'; 
    } else {
        $property_label = 'Asset';
    }
} else {
    // Adjust the label based on the total listings found for other pages
    if( $total_listing_found > 1 ) {
